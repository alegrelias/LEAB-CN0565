...
| **Errores con `venv` (rutas rotas)**                    | Si el entorno virtual falla al activarse o no encuentra las rutas de acceso a los archivos (falla habitual al mover la carpeta del proyecto a otra ubicación):<br>1. Eliminar manualmente la carpeta `env` y volver a crearla con `py -m venv env`.<br>2. Para consultar buenas prácticas de gestión del entorno virtual revisar: **[Tutorial oficial de Python: Entornos virtuales y paquetes](https://docs.python.org/es/3/tutorial/venv.html)**. |
...
| **Exception: No Device Found**                          | Posible solución: verificar el numero de puerto `COM` en el `script` del archivo `.py`                                                                                                                                                                                                                                                                                                                                                              |
